...
def get_config():
    ...
    conf["sync"] = list_from_env_array("BUILDKITE_PLUGIN_PERFORCE_SYNC", {"<stream>": get_stream_from_buildkite})
    ...
    conf["interrupted_flag"] = os.environ.get("BUILDKITE_PLUGIN_PERFORCE_INTERRUPTED_FLAG") or os.path.join(
        os.environ.get("BUILDKITE_BUILD_CHECKOUT_PATH"), "p4interrupted.flag"
    )
